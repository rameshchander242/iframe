...
{!! Form::open(['method' => 'POST', 'route' => ['location.store'], 'id'=>'locationForm']) !!}
    ...
    <div class="form-group">
        ...
        {!! Form::text('store_name', old('store_name'), ['class'=>'form-control', 'placeholder'=>'Store Name', 'maxlength'=>200, 'required'=>true]) !!}
        {!! $errors->first('store_name', '<p class="text-danger">:message</p>') !!}
    </div>
    <div class="form-group">
        {!!Form::label('address_1', 'Address')!!} <span class="text-danger">*</span>
        {!! Form::text('address_1', old('address_1'), ['class'=>'form-control', 'placeholder'=>'Address', 'maxlength'=>200, 'required'=>true]) !!}
        {!! $errors->first('address_1', '<p class="text-danger">:message</p>') !!}
    </div>
    <div class="form-group">
        {!!Form::label('address_2', 'Address 2')!!}
        {!! Form::text('address_2', old('address_2'), ['class'=>'form-control', 'placeholder'=>'Address 2', 'maxlength'=>200]) !!}
    </div>
    <div class="row">
        <div class="col-sm-6">
            <div class="form-group">
                {!!Form::label('city', 'City')!!} <span class="text-danger">*</span>
                {!! Form::text('city', old('city'), ['class'=>'form-control', 'placeholder'=>'City', 'maxlength'=>100, 'required'=>true]) !!}
    ...
    <div class="row">
        <div class="col-sm-6">
            <div class="form-group">
                ...
                {!! Form::email('email', old('email'), ['class'=>'form-control', 'placeholder'=>'Email', 'maxlength'=>200, 'required'=>true]) !!}
        ...
        <div class="col-sm-6">
            <div class="form-group">
                ...
                {!! Form::email('additional_email', old('additional_email'), ['class'=>'form-control', 'placeholder'=>'Additional Email', 'maxlength'=>255]) !!}
            </div>
        </div>
    </div>
    <div class="form-group">
        {!!Form::label('map_url', 'Map Url')!!}
        {!! Form::url('map_url', old('map_url'), ['class'=>'form-control', 'placeholder'=>'Map Url', 'maxlength'=>255]) !!}
    </div>
    <div class="row">
        <div class="col-sm-6">
            <div class="form-group">
                {!!Form::label('ctm_code', 'CTM Code')!!}
                {!! Form::text('ctm_code', old('ctm_code'), ['class'=>'form-control', 'placeholder'=>'CTM Code', 'maxlength'=>200]) !!}
        ...
        <div class="col-sm-6">
            <div class="form-group">
                ...
                {!! Form::text('price_sheet', old('price_sheet'), ['class'=>'form-control', 'placeholder'=>'Price Sheet', 'maxlength'=>100]) !!}
            </div>
        </div>
    </div>
    <div class="form-group">
        ...
        <div class="row mb-3 time-schedule">
            <label class="col-sm-4">
                {!! Form::checkbox('hours['.$hr_key.'][status]', 1, false) !!}
                &nbsp; {{$hr_val}}
            </label>
            <div class="col-sm-4">
                <div class="input-group">
                    ...
                    {!! Form::select('hours['.$hr_key.'][from]', $hrs, '', ['class'=>'form-control min_hr', 'placeholder'=>'-- Select Hour --']) !!}
                </div>
            ...
            <div class="col-sm-4">
                <div class="input-group">
                    ...
                    {!! Form::select('hours['.$hr_key.'][to]', $hrs, '', ['class'=>'form-control max_hr', 'placeholder'=>'-- Select Hour --']) !!}
                </div>
                <span class="text-danger hr-alert"></span>
            </div>
        </div>
