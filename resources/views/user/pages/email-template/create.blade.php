...
@section('content')
{!! Form::open(['method' => 'POST', 'route' => ['user.email-template.store']]) !!}
{!! Form::hidden('user_id', Auth::id()) !!}
<div class="row">
    <div class="col-sm-8">
        <div class="form-group">
            {!!Form::label('iframe_id', 'Price List')!!}: 
            {!! Form::select('iframe_id', $iframes, old('iframe_id'), ['class'=>'form-control', 'id'=>'iframe_id']) !!}
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            ...
            {!! Form::select('category_id', $categories, old('category_id'), ['class'=>'form-control', 'id'=>'category']) !!}
        </div>
