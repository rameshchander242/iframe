...
@section('content')
    {!! Form::open(['method' => 'PUT', 'route' => ['user.location.update', $id], 'files' => true, 'id'=>'locationForm']) !!}
        ...
        <div class="row">
            <div class="col-sm-6">
                <div class="form-group">
                    ...
                    {!! Form::email('email', $email, ['class'=>'form-control', 'placeholder'=>'Email', 'maxlength'=>100, 'required'=>true]) !!}
