...
<form action="{{ route('basic-profile') }}" method="post">
  {{ csrf_field() }}
  ...
  <div class="form-group">
    <label>Contact</label>
    <input type="tel" class="form-control validate_number" maxlength="10" placeholder="Contact" value="{{  $user->phone }}" name = "phone" required>
